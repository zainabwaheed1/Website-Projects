...
document.addEventListener('DOMContentLoaded', function() {
  ...
  listItems.forEach((listItem) => {
    ...
    image.src = 'https://beyonderissolutions.com/products/eris-hr-one/wp-content/uploads/2023/07/betterdocs-cat-icon.svg';
...
checkPopUp('pop1')
		   $(this).addClass("active").siblings().removeClass("active");
		    let imgTag1 = $('<img>').attr('src', 'https://beyonderissolutions.com/products/eris-hr-one/wp-content/uploads/2023/07/3.jpg').attr('alt', 'Image');
  $(".ticket_management .features-list .item:first-child").click(function(){
    $(".cover").fadeIn("300");
  })
...
// 	----------------------------------------------------------
	  $('.ticket_management .features-list .item:nth-child(2)').click(function(){
		  checkPopUp('pop2');
		$(this).addClass("active").siblings().removeClass("active");
		let imgTag2 = $('<img>').attr('src', 'https://beyonderissolutions.com/products/eris-hr-one/wp-content/uploads/2023/07/4.jpg').attr('alt', 'Image');
...
// -------------------------------------------------------------------
	  $('.ticket_management .features-list .item:last-child').click(function(){
		  checkPopUp('pop3');
		$(this).addClass("active").siblings().removeClass("active");
		let imgTag3 = $('<img>').attr('src', 'https://beyonderissolutions.com/products/eris-hr-one/wp-content/uploads/2023/07/5.jpg').attr('alt', 'Image');
...
// Section Second Tab code
	$(window).on('load', function() {
			$('.featured-image-style.col-lg-6.thumb img') .attr('src', 'https://beyonderissolutions.com/products/eris-hr-one/wp-content/uploads/2023/07/1.jpg').fadeIn();
    ...
    $('.discover_tabs li.featured-image-style2:first-child').click(function(){
	  ...
	  $('.col-lg-6.info.ml-auto ul li:nth-child(2)').click(function(){
		$('.featured-image-style.col-lg-6.thumb img') .attr('src', 'https://beyonderissolutions.com/products/eris-hr-one/wp-content/uploads/2023/07/2.jpg');
   })
	  $('.discover_tabs li.featured-image-style2:last-child').click(function(){
		$('.featured-image-style.col-lg-6.thumb img') .attr('src', 'https://beyonderissolutions.com/products/eris-hr-one/wp-content/uploads/2023/07/6.jpg');
   })
