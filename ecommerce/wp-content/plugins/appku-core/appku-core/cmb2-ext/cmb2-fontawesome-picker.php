...
class KS_FontAwesome_IconPicker {
   ...
   public function sanitize( $sanitized_val, $val ) {
    ...
    protected function setup_admin_scripts() {
    	...
    	// wp_enqueue_script( 'cmb2-fontawesome-picker', plugins_url('js/fontawesome-iconpicker.min.js', __FILE__), array('jquery'), self::VERSION, true );
        // wp_enqueue_script( 'cmb2-fontawesome-picker-init',plugins_url('js/fontawesome-picker-init.js', __FILE__), array('cmb2-fontawesome-picker'), self::VERSION, true );
        // wp_enqueue_style( 'cmb2-fontawesome-css', get_theme_file_uri('/assets/css/font-awesome.min.css')  , array(), '1.0' );
        // wp_enqueue_style( 'bootstrap-popovers',plugins_url('css/bootstrap-popovers.css', __FILE__), array('cmb2-fontawesome-css'), self::VERSION );
        // wp_enqueue_style( 'cmb2-fontawesome-picker',plugins_url('css/fontawesome-iconpicker.min.css', __FILE__) , array('bootstrap-popovers'), self::VERSION );
        // wp_enqueue_style( 'cmb2-fontawesome-picker-fixes',plugins_url('css/cmb2-fixes.css', __FILE__), array('cmb2-fontawesome-picker'), self::VERSION );
    }
}
