...
// the opt_name is set to appku_opt.  Please replace it if change your opt_name name.
add_action( 'redux/page/appku_opt/enqueue', 'appku_faIconFont' );
function appku_faIconFont() {
	
  //  Font awesome enqueue
  wp_enqueue_style( 'font-awesome', APPKU_DIR_CSS_URI.'font-awesome.min.css', array(), '4.7.0', 'all' );
  
  // Redux admin css enqueue
  wp_enqueue_style( 'appku-redux-admin', APPKU_DIR_URI.'inc/redux-custom-field/assets/appku.redux.admin.css', array(), '1.0' );
  
  // Redux admin js enqueue
  wp_enqueue_script( 'appku-redux-admin', APPKU_DIR_URI.'inc/redux-custom-field/assets/appku.redux.admin.js', array( 'jquery' ), '1.0', true );
