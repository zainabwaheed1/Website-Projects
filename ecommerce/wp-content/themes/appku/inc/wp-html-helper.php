...
// image default alt
if( !function_exists( 'appku_img_default_alt' ) ){
	function appku_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'appku_img_tag' ) ){
	function appku_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = appku_img_default_alt( $site_name );
		}
...
// Anchor Tag
if( !function_exists( 'appku_anchor_tag' ) ){
	function appku_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'appku_heading_tag' ) ){
	function appku_heading_tag( array $args ){

		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => __( 'Write Something', 'appku' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'data-animate'=> '',
			'data-delay'  => '',
...
// Paragraph Tag
if( !function_exists( 'appku_paragraph_tag' ) ){
	function appku_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'appku_span_tag' ) ){
	function appku_span_tag( array $args ){
