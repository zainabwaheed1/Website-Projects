...
(function ($) {
  ...
  var validnavs = {
    ...
    event: function () {
      ...
      // Navbar Fixed
      // ------------------------------------------------------------------------------ //
    //  if (getNav.hasClass("secondry-menu-wrapper")) {
        $(window).on("scroll", function () {
          var scrollTop = $(window).scrollTop();
          if (scrollTop > 34) {
            $(".secondry-menu-wrapper").addClass("navbar-fixed-secondry");
			$(".transparent-nav").addClass("bg-nav");
          } else {
            $(".secondry-menu-wrapper").removeClass("navbar-fixed-secondry");
			$(".transparent-nav").addClass("bg-nav");
          }
        });
    //  }
