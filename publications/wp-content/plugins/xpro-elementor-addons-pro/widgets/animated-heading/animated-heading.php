...
class Animated_Heading extends Widget_Base {
	...
	public function get_title() {
		return __( 'Animated Headline', 'xpro-elementor-addons-pro' );
	}
	...
	public function get_icon() {
		return 'xi-animated-heading xpro-widget-pro-label';
	}
	...
	public function get_keywords() {
		return array( 'animated', 'heading', 'gradient', 'masking' );
	}
	...
	public function render_title() {
		...
		$animated_text  = '';
		$animated_text .= ' <span class="xpro-title-focus"><span>' . esc_html( $settings['title_center'] ) . '</span>';
		$animated_text .= '</span>';

		$title = esc_html( $settings['title_before'] ) . ( ( ! empty( $settings['title_center'] ) ) ? $animated_text : '' ) . ' ' . esc_html( $settings['title_after'] );
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title_center',
			array(
				'label'              => __( 'Animated Title', 'xpro-elementor-addons-pro' ),
				'description'        => __( '(e.g. Simple , Good , Unique)', 'xpro-elementor-addons-pro' ),
				'type'               => Controls_Manager::TEXTAREA,
				'default'            => 'Innovative, Animated, Creative',
				'dynamic'            => array(
					'active' => true,
				),
				'label_block'        => true,
		...
		$this->add_control(
			...
			array(
				...
				'options'            => array(
					...
					'typed-1'         => __( 'Typewriter', 'xpro-elementor-addons-pro' ),
					'hueRotate'       => __( 'Hue Rotate', 'xpro-elementor-addons-pro' ),
				),
				'frontend_available' => true,
		...
		$this->add_control(
			'center_title_animation_cursor',
			array(
				'label'              => __( 'Type Cursor', 'xpro-elementor-addons-pro' ),
				...
				'frontend_available' => true,
				'condition'          => array(
					'center_title_animation' => 'typed-1',
				),
			)
		);

		$this->add_control(
			'center_title_animation_speed',
			array(
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Typography', 'xpro-elementor-addons-pro' ),
				'selector' => '{{WRAPPER}} .xpro-title-focus > span',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Text Shadow', 'xpro-elementor-addons-pro' ),
				'selector' => '{{WRAPPER}} .xpro-title-focus:not(.morphext) ,{{WRAPPER}} .morphext > span',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'    => array(
					'{{WRAPPER}} .xpro-title-focus:not(.morphext) ,{{WRAPPER}} .morphext > span' => '-webkit-background-clip: text; -webkit-text-fill-color: transparent; background-color: transparent;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .xpro-title-focus:not(.morphext) ,{{WRAPPER}} .morphext > span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .xpro-title-focus:not(.morphext),{{WRAPPER}} .morphext > span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .xpro-title-focus' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
	...
	protected function render() {
		...
		require XPRO_ELEMENTOR_ADDONS_PRO_WIDGET . 'animated-heading/layout/frontend.php';
