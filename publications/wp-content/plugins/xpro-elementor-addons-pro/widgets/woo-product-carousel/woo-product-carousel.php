...
class Woo_Product_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'xpro-woo-product-carousel';
	}
	...
	public function get_title() {
		return __( 'Woo Product Carousel', 'xpro-elementor-addons-pro' );
	}
	...
	public function get_keywords() {
		return array( 'woo', 'product', 'post', 'grid', 'blog', 'posts', 'query', 'carousel' );
	}
	...
	public function get_style_depends() {
		return array( 'owl-carousel', 'animate' );
	}
	...
	public function get_script_depends() {
		return array( 'owl-carousel', 'wc-add-to-cart-variation' );
	}
	...
	protected function register_controls() {
		...
		$post_types['product']        = __( 'Product', 'xpro-elementor-addons-pro' );
		...
		$this->add_control(
			'show_category',
			array(
				'label'        => __( 'Show Category', 'xpro-elementor-addons-pro' ),
		...
		$this->add_control(
			'show_rating',
			array(
				'label'        => __( 'Show Rating', 'xpro-elementor-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
			)
		...
		$this->add_control(
			'show_price',
			array(
				'label'        => __( 'Show Price', 'xpro-elementor-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
			)
		...
		$this->add_control(
			'show_qv_action',
			array(
				'label'        => __( 'Show Quick View Action', 'xpro-elementor-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
			)
		);
		...
		$this->add_control(
			'show_qv_icon',
			array(
				'label'        => __( 'Show Quick View Icon', 'xpro-elementor-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
				'condition'    => array(
		...
		$this->add_control(
			'show_cart_icon',
			array(
				'label'        => __( 'Show Cart Icon', 'xpro-elementor-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
				'condition'    => array(
		...
		$this->add_control(
			'show_cta',
			array(
				'label'        => __( 'Show CTA Button', 'xpro-elementor-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'no',
			)
		...
		$this->add_control(
			'filter_by',
			array(
				'label'     => __( 'Filter By', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => array(
					''             => __( 'None', 'xpro-elementor-addons-pro' ),
					'featured'     => __( 'Featured', 'xpro-elementor-addons-pro' ),
					'sale'         => __( 'Sale', 'xpro-elementor-addons-pro' ),
					'top_rated'    => __( 'Top Rated', 'xpro-elementor-addons-pro' ),
					'best_selling' => __( 'Best Selling', 'xpro-elementor-addons-pro' ),
				),
				'condition' => array(
					'post_type!' => array( 'by_id', 'source_dynamic' ),
				),
		...
		$this->start_controls_section(
			'qv_section',
			array(
				'label'     => __( 'Quick View', 'xpro-elementor-addons-pro' ),
				'condition' => array(
					'show_qv_action' => 'yes',
					'show_qv_icon'   => 'yes',
				),
		...
		$this->start_controls_section(
			'badges_section',
			array(
				'label' => __( 'Badges', 'xpro-elementor-addons-pro' ),
			)
		);
		...
		$this->add_control(
			'show_badges',
			array(
				'label'        => __( 'Show Badges', 'xpro-elementor-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
			)
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'                 => Controls_Manager::SELECT,
				'options'              => array(
					'square' => __( 'Square', 'xpro-elementor-addons-pro' ),
					'circle' => __( 'Circle', 'xpro-elementor-addons-pro' ),
				),
				'default'              => 'square',
				'condition'            => array(
					'show_badges' => 'yes',
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'                 => Controls_Manager::SELECT,
				'options'              => array(
					'column' => __( 'Column', 'xpro-elementor-addons-pro' ),
					'row'    => __( 'Row', 'xpro-elementor-addons-pro' ),
				),
				'default'              => 'column',
				'condition'            => array(
					'show_badges' => 'yes',
		...
		$this->add_responsive_control(
			'sale_badge_type',
			array(
				'label'     => __( 'Sale Badge Type', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => array(
					'text'       => __( 'Text', 'xpro-elementor-addons-pro' ),
					'percentage' => __( 'Percentage', 'xpro-elementor-addons-pro' ),
				),
				'default'   => 'text',
				'condition' => array(
					'show_badges' => 'yes',
		...
		$this->add_control(
			'show_sale_badge',
			array(
				'label'        => __( 'Show Sale Badge', 'xpro-elementor-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
				'separator'    => 'before',
		...
		$this->add_control(
			'show_featured_badge',
			array(
				'label'        => __( 'Show Featured Badge', 'xpro-elementor-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
				'condition'    => array(
		...
		$this->add_control(
			'category_title',
			array(
				'label'     => __( 'Category', 'xpro-elementor-addons-pro' ),
		...
		$this->add_responsive_control(
			'space_between_price',
			array(
				'label'      => __( 'Space Between Sale Price', 'xpro-elementor-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
		...
		$this->add_group_control(
			...
			array(
				...
				'label'     => __( 'Sale Typography', 'xpro-elementor-addons-pro' ),
				'separator' => 'before',
		...
		$this->add_control(
			'sale_price_color',
			array(
				'label'     => __( 'Sale Color', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->start_controls_section(
			'qv_action_style',
			array(
				'label'     => __( 'Actions', 'xpro-elementor-addons-pro' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'show_qv_action' => 'yes',
				),
		...
		$this->start_controls_section(
			'qv_style',
			array(
				'label'     => __( 'Popup Content', 'xpro-elementor-addons-pro' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'show_qv_action' => 'yes',
					'show_qv_icon'   => 'yes',
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => __( 'Link Padding', 'xpro-elementor-addons-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => __( 'Text Margin', 'xpro-elementor-addons-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->start_controls_section(
			...
			array(
				'label'     => __( 'Popup Buttons', 'xpro-elementor-addons-pro' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'show_qv_action' => 'yes',
					'show_qv_icon'   => 'yes',
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Quantity Buttons Input', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->start_controls_section(
			'variations_styles',
			array(
				'label' => esc_html__( 'Popup Variations', 'xpro-elementor-addons-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => esc_html__( 'Typography', 'xpro-elementor-addons-pro' ),
		...
		$this->add_control(
			...
			array(
				'label'                => esc_html__( 'Display Style', 'xpro-elementor-addons-pro' ),
				'type'                 => Controls_Manager::CHOOSE,
				'default'              => 'row',
				'options'              => array(
					'row'    => array(
		...
		$this->add_control(
			...
			array(
				'label'      => esc_html__( 'Label Width', 'xpro-elementor-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->start_controls_tab(
			'variation_price_tab',
			array(
				'label' => esc_html__( 'Price', 'xpro-elementor-addons-pro' ),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => esc_html__( 'Typography', 'xpro-elementor-addons-pro' ),
				'selector' => '{{WRAPPER}} .variations :is(.price, .price del, .price ins )',
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Price Color', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Sale Price Color', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Discount Badge Color', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'alpha'     => false,
				'default'   => '#FFFFFF',
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Discount Badge Background', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'alpha'     => false,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'      => esc_html__( 'Badge Font Size', 'xpro-elementor-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			'variation_dropdown',
			array(
				'label'     => esc_html__( 'Dropdown', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Dropdown Color', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Popup Swatches', 'xpro-elementor-addons-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'      => esc_html__( 'Swatch Width', 'xpro-elementor-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			...
			array(
				'label'      => esc_html__( 'Swatch Height', 'xpro-elementor-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Selected Border', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_responsive_control(
			'badges_btn_margin',
			array(
				'label'      => __( 'Buttons Spacing', 'xpro-elementor-addons-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->add_control(
			'sale_badge_heading',
			array(
				'label'     => __( 'Sale', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => array(
					'show_sale_badge' => 'yes',
		...
		$this->add_control(
			'out_stock_heading',
			array(
				'label'     => __( 'Out Of Stock', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		<div class="xpro-product-grid-wrapper xpro-woo-product-grid-layout-<?php echo esc_attr( $settings['layout'] ); ?>">
			...
			if ( 'source_dynamic' === $settings['post_type'] && ( 'xpro-themer' === get_post_type() || 'xpro_content' === get_post_type() ) ) {
				...
				if ( empty( $dynamic_args ) ) {
					$dynamic_args['post_type']      = 'product';
			...
			if ( $query->have_posts() ) {
				...
				<div id="xpro-product-carousel-<?php echo esc_attr( $this->get_id() ); ?>" class="xpro-woo-product-grid-main owl-carousel xpro-owl-theme xpro-owl-navigation-horizontal-<?php echo esc_attr( $settings['nav_layout'] ?? 'style-1' ); ?> xpro-owl-dots-horizontal-<?php echo esc_attr( $settings['dots_layout'] ?? 'style-1' ); ?>">
					<?php
					while ( $query->have_posts() ) {
						$query->the_post();

						require XPRO_ELEMENTOR_ADDONS_PRO_WIDGET . 'woo-product-carousel/layout/frontend.php';
					}
					wp_reset_postdata();
					?>
				</div>
				...
				<p class="xpro-alert xpro-alert-warning">
					<span class="xpro-alert-title"><?php echo esc_html__( 'No Products Found!', 'xpro-elementor-addons-pro' ); ?></span>
