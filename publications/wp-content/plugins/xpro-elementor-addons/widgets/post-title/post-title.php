...
class Post_Title extends Widget_Base {
	...
	public function get_title() {
		return __( 'Post Title', 'xpro-elementor-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .xpro-post-title-icon-left > .xpro-post-title-icon'  => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .xpro-post-title-icon-right > .xpro-post-title-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}.elementor-widget-xpro-post-title' => 'text-align: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			'post_link',
			array(
				'label'        => __( 'Post Link', 'xpro-elementor-addons' ),
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .xpro-post-title',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .xpro-post-title-text'   => 'color: {{VALUE}};',
					'{{WRAPPER}} .xpro-post-title-icon i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .xpro-post-title-icon svg' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-post-title-text' => '-webkit-text-stroke-width: 1px; -webkit-text-stroke-color: {{VALUE}};',
				),
				'condition' => array(
					'title_stroke' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .xpro-post-title-text' => '-webkit-text-stroke-width: {{SIZE}}{{UNIT}};',
				),
				'condition'  => array(
					'title_stroke' => 'yes',
				),
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'title_shadow',
				'selector' => '{{WRAPPER}} .xpro-post-title-text,{{WRAPPER}} .xpro-post-title-icon',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => Controls_Manager::SLIDER,
				'selectors' => array(
					'{{WRAPPER}} .xpro-post-title-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .xpro-post-title-icon svg' => 'height:auto; width: {{SIZE}}{{UNIT}};',
				),
			)
		);
	...
	protected function render() {
		...
		require XPRO_ELEMENTOR_ADDONS_WIDGET . 'post-title/layout/frontend.php';
	}
}
