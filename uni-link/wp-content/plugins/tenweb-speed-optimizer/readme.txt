...
= 2.32.11 =
Improved: Security during cache clear

= 2.32.7 =
Improved: Stability when writing wp-config.php file
Improved: Caching error pages logic

= 2.32.4 =
Removed: NPS survey

= 2.32.3 =
Added: New option to optimize custom post type archive pages without generating Critical CSS
Fixed: Wordpress guidelines
...
Improved: CLI cache clearing features
Improved: Max cache size is dynamic now
Fixed: Clearing cache from header menu
