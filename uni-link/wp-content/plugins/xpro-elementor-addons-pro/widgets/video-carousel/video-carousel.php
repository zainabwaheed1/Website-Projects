...
class Video_Carousel extends Widget_Base {
	...
	public function get_title() {
		return __( 'Video Carousel', 'xpro-elementor-addons-pro' );
	}
	...
	public function get_keywords() {
		return array( 'carousel', 'slider', 'lightbox', 'video' );
	}
	...
	public function get_style_depends() {
		return array( 'owl-carousel', 'fancybox' );
	}
	...
	protected function render() {
		...
		require XPRO_ELEMENTOR_ADDONS_PRO_WIDGET . 'video-carousel/layout/frontend.php';
