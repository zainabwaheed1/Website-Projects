...
class Loop_Carousel extends Widget_Base {
	...
	public function get_title() {
		return __( 'Loop Carousel', 'xpro-elementor-addons-pro' );
	}
	...
	public function get_keywords() {
		return array( 'post', 'loop', 'builder', 'posts', 'query', 'carousel' );
	}
	...
	protected function render() {
		...
		<div class="xpro-loop-builder-wrapper">
			...
			if ( $query->have_posts() && '' !== $settings['select_template'] ) {
				...
				<div id="xpro-loop-builder-<?php echo esc_attr( $this->get_id() ); ?>" class="xpro-loop-builder-main owl-carousel xpro-owl-theme xpro-owl-navigation-horizontal-<?php echo esc_attr( $settings['nav_layout'] ?? 'style-1' ); ?> xpro-owl-dots-horizontal-<?php echo esc_attr( $settings['dots_layout'] ?? 'style-1' ); ?>">
						<?php
									...
									foreach ( $settings['individual_template_condition'] as $template ) {
										if ( '' !== $template['select_template_individual'] ) {
											if ( ( 'yes' == $template['individual_every_post'] && $count % $template['individual_post'] == 0 ) || ( $template['individual_post'] == $count ) ) {
												?>
												<div class="xpro-loop-builder-item">
													<?php
				...
				<p class="xpro-alert xpro-alert-warning">
					<span class="xpro-alert-title"><?php echo esc_html__( 'No Posts or Template Found!', 'xpro-elementor-addons-pro' ); ?></span>
