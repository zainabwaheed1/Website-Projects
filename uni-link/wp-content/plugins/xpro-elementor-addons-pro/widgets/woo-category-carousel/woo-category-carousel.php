 ...
 * @since 0.1.8
 */
class Woo_Category_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'xpro-woo-category-carousel';
	}
	...
	public function get_title() {
		return __( 'Woo Category Carousel', 'xpro-elementor-addons-pro' );
	}
	...
	protected function render() {
		...
		<div class="xpro-product-grid-wrapper xpro-woo-product-cat-wrapper xpro-woo-product-cat-layout-<?php echo esc_attr( $settings['layout'] ); ?>">
			...
			<div id="xpro-category-carousel-<?php echo esc_attr( $this->get_id() ); ?>" class="xpro-woo-product-grid-main owl-carousel xpro-owl-theme xpro-owl-navigation-horizontal-<?php echo esc_attr( $settings['nav_layout'] ?? 'style-1' ); ?> xpro-owl-dots-horizontal-<?php echo esc_attr( $settings['dots_layout'] ?? 'style-1' ); ?>">
				<?php
				require XPRO_ELEMENTOR_ADDONS_PRO_WIDGET . 'woo-category-carousel/layout/frontend.php';
				?>
			</div>
