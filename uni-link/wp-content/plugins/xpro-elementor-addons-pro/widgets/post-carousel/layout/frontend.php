		...
		<?php if ( 'yes' === $settings['show_author'] && '4' !== $settings['layout'] ) : ?>
            <div class="xpro-post-grid-author">
                ...
                <div class="xpro-post-grid-author-content">
					...
					<?php endif; ?>
                    <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" class="xpro-post-grid-author-name"><?php echo esc_html( get_the_author_meta( 'display_name' ) ); ?></a>
                </div>
            </div>
		<?php endif; ?>
