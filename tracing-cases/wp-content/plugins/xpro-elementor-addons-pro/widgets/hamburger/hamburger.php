 ...
 * @since 0.1.8
 */
class Hamburger extends Widget_Base {
	...
	public function get_title() {
		return __( 'Hamburger', 'xpro-elementor-addons-pro' );
	}
	...
	public function get_icon() {
		return 'xi-hamburger xpro-widget-pro-label';
	}
	...
	public function get_keywords() {
		return array( 'hamburger', 'menu', 'side menu', 'off canvas' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options'            => array(
					...
					'fullFromTop'    => __( 'Full From Top', 'xpro-elementor-addons-pro' ),
					'fullFromBottom' => __( 'Full From Bottom', 'xpro-elementor-addons-pro' ),
				),
		...
		$this->add_control(
			'xpro_elementor_hamburger_template',
			array(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default'   => '',
				'selectors' => array(
					'{{WRAPPER}} .xpro-elementor-hamburger-toggle-wrapper' => 'text-align: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'condition'  => array(
					'layout!' => array( 'fullFadeIn', 'fullFromTop', 'fullFromBottom' ),
				),
				'selectors'  => array(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} [class*=xpro-elementor-hamburger-layout-full] .xpro-elementor-hamburger-inner' => 'height: {{SIZE}}{{UNIT}}',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .xpro-elementor-hamburger-toggle' => 'width: {{SIZE}}{{UNIT}}; max-width:100%;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .xpro-elementor-hamburger-toggle' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
	...
	protected function render() {
		...
		require XPRO_ELEMENTOR_ADDONS_PRO_WIDGET . 'hamburger/layout/frontend.php';
