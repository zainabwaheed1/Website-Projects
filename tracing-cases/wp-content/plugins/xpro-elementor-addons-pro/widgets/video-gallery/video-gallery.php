...
class Video_Gallery extends Widget_Base {
	...
	public function get_title() {
		return __( 'Video Gallery', 'xpro-elementor-addons-pro' );
	}
	...
	public function get_icon() {
		return 'xi-masonry-layout xpro-widget-pro-label';
	}
	...
	public function get_style_depends() {
		...
		return array( 'cubeportfolio', 'fancybox' );
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			array(
				...
				'type'        => Controls_Manager::TEXT,
				'placeholder' => __( 'Type gallery item title.', 'xpro-elementor-addons-pro' ),
				'default'     => __( 'Video Title', 'xpro-elementor-addons-pro' ),
				'label_block' => true,
				'dynamic'     => array(
					'active' => true,
				),
		...
		$repeater->add_control(
			...
			array(
				...
				'default'     => 'video',
				'options'     => array(
					'image'   => __( 'Image', 'xpro-elementor-addons-pro' ),
					'video'   => __( 'URL', 'xpro-elementor-addons-pro' ),
					'youtube' => __( 'Youtube', 'xpro-elementor-addons-pro' ),
					'vimeo'   => __( 'Vimeo', 'xpro-elementor-addons-pro' ),
				),
			)
		);
		...
		$repeater->add_control(
			'content_image',
			array(
				'label'     => __( 'Lightbox Image', 'xpro-elementor-addons-pro' ),
				'type'      => Controls_Manager::MEDIA,
				'default'   => array(
					'url' => Utils::get_placeholder_image_src(),
				),
		...
		$repeater->add_control(
			'vimeo_link',
			array(
				'label'       => __( 'Lightbox Link', 'xpro-elementor-addons-pro' ),
				'type'        => Controls_Manager::URL,
			...
			array(
				...
				'default'     => array(
					array(
						...
						'title_text'            => __( 'Video Title 1', 'xpro-elementor-addons-pro' ),
						'lightbox_content_type' => 'video',
					),
					array(
						'filter'                => __( 'Filter 1', 'xpro-elementor-addons-pro' ),
						'title_text'            => __( 'Video Title 2', 'xpro-elementor-addons-pro' ),
						'lightbox_content_type' => 'youtube',
					),
					array(
						'filter'                => __( 'Filter 3', 'xpro-elementor-addons-pro' ),
						'title_text'            => __( 'Video Title 3', 'xpro-elementor-addons-pro' ),
						'lightbox_content_type' => 'vimeo',
					),
				),
			)
	...
	protected function render() {
		...
		require XPRO_ELEMENTOR_ADDONS_PRO_WIDGET . 'video-gallery/layout/frontend.php';
