...
class Advance_Portfolio extends Widget_Base {
	...
	public function get_title() {
		return __( 'Advanced Portfolio', 'xpro-elementor-addons-pro' );
	}
	...
	public function get_icon() {
		return 'xi-advance-portfolio xpro-widget-pro-label';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'gallery_style',
			array(
				'label'              => __( 'Portfolio Layout', 'xpro-elementor-addons-pro' ),
		...
		$repeater->add_control(
			...
			array(
				...
				'description' => __( 'Filter name will be used in filter menu.', 'xpro-elementor-addons-pro' ),
		...
		$repeater->add_control(
			...
			array(
				...
				'default'     => __( 'Portfolio Title 1', 'xpro-elementor-addons-pro' ),
				'label_block' => true,
				'dynamic'     => array(
					'active' => true,
				),
		...
		$repeater->add_control(
			...
			array(
				...
				'default'     => __( 'Creative Portfolio', 'xpro-elementor-addons-pro' ),
				'dynamic'     => array(
					'active' => true,
				),
			)
			...
			array(
				...
				'default'     => array(
					array(
						...
						'desc_text'  => __( 'Creative Portfolio', 'xpro-elementor-addons-pro' ),
					),
					array(
						'filter'     => __( 'Filter 1', 'xpro-elementor-addons-pro' ),
					...
					array(
						...
						'title_text' => __( 'Portfolio Title 3', 'xpro-elementor-addons-pro' ),
						'desc_text'  => __( 'Creative Portfolio', 'xpro-elementor-addons-pro' ),
					),
				),
			)
		...
		$this->add_responsive_control(
			...
			array(
				...
				'description'        => __( 'Adjust the height of items.', 'xpro-elementor-addons-pro' ),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default'   => 'left',
				'selectors' => array(
					'{{WRAPPER}} .xpro-outside-content' => 'text-align: {{VALUE}};',
				),
				'condition' => array(
					'gallery_style' => 'masonry',
					'text_outside'  => 'yes',
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-elementor-gallery .xpro-item-btn:hover,{{WRAPPER}} .xpro-elementor-gallery .xpro-item-btn:focus' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-elementor-gallery .xpro-item-btn:hover,{{WRAPPER}} .xpro-elementor-gallery .xpro-item-btn:focus' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-elementor-gallery .xpro-item-btn:hover,{{WRAPPER}} .xpro-elementor-gallery .xpro-item-btn:focus' => 'border-color: {{VALUE}}',
				),
			)
		);
	...
	protected function render() {
		...
		require XPRO_ELEMENTOR_ADDONS_PRO_WIDGET . 'advance-portfolio/layout/frontend.php';
