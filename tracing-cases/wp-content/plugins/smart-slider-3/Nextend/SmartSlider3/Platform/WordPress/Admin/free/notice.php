...
if (mktime(0, 0, 0, 11, 24, 2025) <= $current && $current < mktime(0, 0, 0, 12, 2, 2025)) {
    if (get_option('ss3_bf_2025') != '1') {

        add_action('admin_notices', function () {
            ?>
            <div class="notice notice-info is-dismissible" data-ss3dismissable="ss3_bf_2025" style="display:grid;grid-template-columns: 100px auto;padding-top: 25px; padding-bottom: 22px;">
                ...
                <p style="margin:0 0 2px;">Get your <b>Smart Slider 3 Pro plan</b> with <b>UP TO 50% OFF</b>! This limited time offer expires on December 1.</p>
                <p style="margin:0;">
                    <a class="button button-primary" href="https://smartslider3.com/pricing/?coupon=BF2025&utm_source=wpfree&utm_medium=wp&utm_campaign=bf25" target="_blank">
                        Buy Now</a>
