            ...
            <div class="col-md-12">
                <div class="breadcrumb-content">
                    <h1>
                        <?php
                        if ( is_day() ) :
                            esc_html_e( 'Daily Archives: ', 'drake' );

                        elseif ( is_month() ) :
                            esc_html_e( 'Monthly Archives: ', 'drake' );

                        
                        elseif ( is_year() ) :
                            esc_html_e( 'Yearly Archives: ', 'drake' );
                    ...
                    <ul class="breadcrumbs">
                        ...
                        <li><?php esc_html_e( 'Archives', 'drake' )?></li>
                    </ul>
                </div>
            </div>
        </div>
